...
def build_parser():
    ...
    parser.add_argument("--valid_path", dest="valid_path", default="/userhome/cs2/lzl0105/dl/NLP/Laptop-ACOS/laptop_quad_dev_with_none.csv")
    ...
    ##Train option
    parser.add_argument("--boost", dest="boost", default=False, type=bool)
    parser.add_argument("--n_epochs", dest="n_epochs", default=4, type=int)
